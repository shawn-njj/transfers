...
echo "[PROMPT 4] LAYER7 ONLY - INPUT THE NGINX CONFIGURATION FILE CONTAINING THE SERVER BLOCK TO HARDEN: (EXAMPLE: /etc/nginx/nginx.conf)"
read SERVER_NAME_FILE

echo "[PROMPT 5] LAYER7 ONLY - INPUT THE SSL CERTIFICATE AND KEY DIRECTORY: (EXAMPLE: /etc/ssl)"
